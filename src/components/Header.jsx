            ...
            {userMenuOpen && (
              <div className="absolute right-0 top-12 w-72 bg-white rounded-2xl shadow-elevated border border-slate-200 py-2 animate-scale-in">
                ...
                <div className="px-4 py-3 border-b border-slate-100">
                  <p className="font-semibold text-slate-800">{state.user?.full_name || 'Juan VanSice'}</p>
                  <p className="text-xs text-slate-500 capitalize">{state.user?.role || 'Administrador'}</p>
                </div>
